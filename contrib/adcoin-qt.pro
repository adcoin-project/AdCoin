...
RESOURCES += src/qt/adcoin.qrc src/qt/adcoin_locale.qrc

TRANSLATIONS += src/qt/locale/adcoin_bg.ts \
                src/qt/locale/adcoin_de.ts \
                src/qt/locale/adcoin_en.ts \
                src/qt/locale/adcoin_es.ts \
                src/qt/locale/adcoin_fi.ts \
                src/qt/locale/adcoin_fr.ts \
                src/qt/locale/adcoin_it.ts \
                src/qt/locale/adcoin_ja.ts \
                src/qt/locale/adcoin_pl.ts \
                src/qt/locale/adcoin_pt.ts \
                src/qt/locale/adcoin_ru.ts \
                src/qt/locale/adcoin_sk.ts \
                src/qt/locale/adcoin_sv.ts \
                src/qt/locale/adcoin_vi.ts \
                src/qt/locale/adcoin_zh_CN.ts \
                src/qt/locale/adcoin_zh_TW.ts
