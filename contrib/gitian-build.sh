...
VERSION=
commit=false
url=https://github.com/adcoin-project/adcoin
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the adcoin, gitian-builder, gitian.sigs, and adcoin-detached-sigs.
...
then
    ...
    then
        ...
        ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs/ ../adcoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    then
        ...
        ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs/ ../adcoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    then
        ...
        ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-unsigned --destination ../gitian.sigs/ ../adcoin/contrib/gitian-descriptors/gitian-osx.yml
    ...
    then
        ...
        echo ""
        ./bin/gbuild -j ${proc} -m ${mem} --commit adcoin=${COMMIT} --url adcoin=${url} ../adcoin/contrib/gitian-descriptors/gitian-aarch64.yml
        ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../adcoin/contrib/gitian-descriptors/gitian-aarch64.yml
        mv build/out/adcoin-*.tar.gz build/out/src/adcoin-*.tar.gz ../adcoin-binaries/${VERSION}
    fi
    popd
...
then
    ...
    then
        ...
        ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs/ ../adcoin/contrib/gitian-descriptors/gitian-win-signer.yml
    ...
    then
        ...
        ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs/ ../adcoin/contrib/gitian-descriptors/gitian-osx-signer.yml
