...
#   c) node1 mines 32 blocks, so now node 0 has 60001adcoin, node 1 has 4250adcoin, node2 has none.
#   d) node0 sends 601 adcoin to node2, in two transactions (301 adcoin, then 300 adcoin).
