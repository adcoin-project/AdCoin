...
In order to support loading of multiple wallets in adcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is adcoin.cpp.
...
Changes to adcoin.cpp
----------------------
adcoin.cpp is the entry point into adcoin-qt, and as such, will require some minor modifications to provide hooks for
