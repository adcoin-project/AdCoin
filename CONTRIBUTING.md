Contributing to ADCOIN Core
============================

The ADCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ADCOIN Core project, and is not to be
confused with overall ADCOIN Network Protocol consensus changes.

Whether a pull request is merged into ADCOIN Core rests with the project merge
...
Patches that change ADCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the ADCOIN consensus, it must have been
...
The project leader is the release manager for each ADCOIN Core release.
