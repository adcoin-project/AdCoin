...
public:
    ...
    bool WriteZADCOINSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZADCOINSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZADCOINSeed_deprecated(uint256& seed);
    bool EraseZADCOINSeed();
    bool EraseZADCOINSeed_deprecated();

    bool WriteZADCOINCount(const uint32_t& nCount);
    bool ReadZADCOINCount(uint32_t& nCount);
