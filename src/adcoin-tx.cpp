...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("adcoin Core adcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  adcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded adcoin transaction") + "\n" +
                               "  adcoin-tx [options] -create [commands]   " + _("Create hex-encoded adcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded adcoin transaction
