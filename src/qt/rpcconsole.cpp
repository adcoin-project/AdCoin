                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzADCOINPathCustom = GetArg("-zadcoinbackuppath", "");
    ...
    if(!strzADCOINPathCustom.empty()) {
        ui->wallet_customzadcoinbackuppath->setText(QString::fromStdString(strzADCOINPathCustom));
        ui->wallet_customzadcoinbackuppath_label->setVisible(true);
        ui->wallet_customzadcoinbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzADCOINPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ADCOIN RPC console.") + "<br>" +
