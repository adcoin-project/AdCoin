...
/* ADCOIN GUI -- Size of icons in status bar */
...
/* Transaction list -- TX status decoration - stake (Dark blue #03a8f5) */
#define COLOR_STAKE QColor(3, 168, 245)
...
#define QAPP_ORG_NAME "ADCOIN"
#define QAPP_ORG_DOMAIN "adcoin.org"
#define QAPP_APP_NAME_DEFAULT "ADCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "ADCOIN-Qt-testnet"
