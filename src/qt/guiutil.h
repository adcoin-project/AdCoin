...
/** Utility functions used by the ADCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render ADCOIN addresses in monospace font
...
// Parse "adcoin:" URI into recipient object, return true on successful parsing
