/* src/config/adcoin-config.h.  Generated from adcoin-config.h.in by configure.  */
/* src/config/adcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ADCOIN_CONFIG_H

#define ADCOIN_CONFIG_H
