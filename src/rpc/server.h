...
extern UniValue setzadcoinseed(const UniValue& params, bool fHelp);
extern UniValue getzadcoinseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzadcoin(const UniValue& params, bool fHelp);
extern UniValue dzadcoinstate(const UniValue& params, bool fHelp);
